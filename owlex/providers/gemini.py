...
class GeminiProvider:
    ...
    def __init__(self, config: ProviderConfig | None = None):
        ...
        # Sandbox mode: default (suggest only) or yolo (auto-approve all)
        self._sandbox_mode = os.environ.get("GEMINI_SANDBOX_MODE", "true").lower() == "true"
        self._approval_mode = os.environ.get("GEMINI_APPROVAL_MODE", "default")  # default, auto_edit, yolo
    ...
    async def call(
        ...
        **kwargs,
        ...
        if self._approval_mode != "default":
            full_command.extend(["--approval-mode", self._approval_mode])
